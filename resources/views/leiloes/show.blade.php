...
<form class="row g-3" action="{{route('lances')}}" method="post">
    @csrf
    @foreach ($leilao->itens as $item)
    <div class="col-md-12">
    Item: {{$item->material->nome}} <br> Quantidade: {{$item->quantidade}}
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="prazo_de_entrega" value="" required name="prazo_de_entrega">
      </div>
    <div class="col-md-12">
